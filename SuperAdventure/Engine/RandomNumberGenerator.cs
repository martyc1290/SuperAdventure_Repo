...
namespace Engine
{
    ...
    public static class RandomNumberGenerator
    {
        ...
        public static int NumberBetween(int minimumValue, int maximumValue)
        {
            ...
            // will always be between 0.0 and 0.99999999999. Otherwise, it's possible for it
            // to be "1", which causes problems in our rounding.
 ...
 /* // The code for the easy way follows...
 using System;
